...
<table class="table table-sm table-borderless p-2">
  ...
  <tr>
    ...
    <tr>
      ...
      <td>
        <input type="date" id="inputTglIzinCuti" name="inputTglIzinCuti" class="form-control form-control-sm mb-1" value="<?php echo date("Y-m-d"); ?>">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <input type="date" id="inputTglAkhirCuti" name="inputTglAkhirCuti" class="form-control form-control-sm mb-1" value="<?php echo date("Y-m-d"); ?>">
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <textarea id="inputAlasan" name="inputAlasan" class="form-control form-control-sm mb-1" placeholder="Alasan Cuti" row="3" required autofocus></textarea>
      </td>
    </tr>
    ...
    <tr>
        ...
        <td><button class="btn btn-primary mt-3" type="button" data-toggle="modal" data-target="#modalKonfirmasi"><i class="fas fa-check fa-fw mr-1"></i>Beri Izin Cuti</button></td>
        <td></td>
...
<?php
    if(isset($_POST['Submit'])){
        ...
        if($query1 && $tglcuti == $hariini){
            $query2 = mysqli_query($koneksi, "UPDATE tbl_masterkaryawan SET status='Cuti' WHERE id_karyawan=$idkaryawan");
        }
